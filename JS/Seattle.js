...
var toxic = L.geoJson(null, {
  style: function (feature) {
    var fillColor,
      density = feature.properties.TRI_2017_SEA_Clipped_Class;
  ...
  onEachFeature: function (feature, layer) {
    layer.bindPopup(
      ...
      "Toxic Class: " +
      "</strong>" +
      feature.properties.TRI_2017_SEA_Clipped_Class
    );
  },
});
...
var bus = L.geoJson(null, {
  style: function (feature) {
    var fillColor,
      density = feature.properties.AAA_Seattle_Bus_Class;
    if (density <= 5 && density > 4) fillColor = "#365c96";
    else if (density <= 4 && density > 3) fillColor = "#5681c2";
    else if (density <= 3 && density > 2) fillColor = "#8fabd6";
    else if (density <= 2 && density > 1) fillColor = "#c7d5eb";
  ...
  onEachFeature: function (feature, layer) {
    layer.bindPopup(
      ...
      "Bus Class: " +
      "</strong>" +
      feature.properties.AAA_Seattle_Bus_Class
    );
  },
});
...
var unemployment = L.geoJson(null, {
  style: function (feature) {
    var fillColor,
      density = feature.properties.AAA_Seattle_Unemployment_Class;
    if (density <= 5 && density > 4) fillColor = "#365c96";
    else if (density <= 4 && density > 3) fillColor = "#5681c2";
    else if (density <= 3 && density > 2) fillColor = "#8fabd6";
    else if (density <= 2 && density > 1) fillColor = "#c7d5eb";
  ...
  onEachFeature: function (feature, layer) {
    layer.bindPopup(
      ...
      "Unemployment Class: " +
      "</strong>" +
      feature.properties.AAA_Seattle_Unemployment_Class
    );
  },
});
...
var commute = L.geoJson(null, {
  style: function (feature) {
    var fillColor,
      density = feature.properties.AAA_Seattle_Commute_Class;
    if (density <= 5 && density > 4) fillColor = "#365c96";
    else if (density <= 4 && density > 3) fillColor = "#5681c2";
    else if (density <= 3 && density > 2) fillColor = "#8fabd6";
    else if (density <= 2 && density > 1) fillColor = "#c7d5eb";
  ...
  onEachFeature: function (feature, layer) {
    layer.bindPopup(
      ...
      "Commute Class: " +
      "</strong>" +
      feature.properties.AAA_Seattle_Commute_Class
    );
  },
});
...
var income = L.geoJson(null, {
  style: function (feature) {
    var fillColor,
      density = feature.properties.AAA_Seattle_Income_Class;
    if (density <= 5 && density > 4) fillColor = "#365c96";
    else if (density <= 4 && density > 3) fillColor = "#5681c2";
    else if (density <= 3 && density > 2) fillColor = "#8fabd6";
    else if (density <= 2 && density > 1) fillColor = "#c7d5eb";
  ...
  onEachFeature: function (feature, layer) {
    layer.bindPopup(
      ...
      "Income Class: " +
      "</strong>" +
      feature.properties.AAA_Seattle_Income_Class
    );
  },
});
...
var education = L.geoJson(null, {
  style: function (feature) {
    var fillColor,
      density = feature.properties.AAA_Seattle_Education_Class;
    if (density <= 5 && density > 4) fillColor = "#365c96";
    else if (density <= 4 && density > 3) fillColor = "#5681c2";
    else if (density <= 3 && density > 2) fillColor = "#8fabd6";
    else if (density <= 2 && density > 1) fillColor = "#c7d5eb";
  ...
  onEachFeature: function (feature, layer) {
    layer.bindPopup(
      ...
      "Education Class: " +
      "</strong>" +
      feature.properties.AAA_Seattle_Education_Class
    );
  },
});
...
var highed = L.geoJson(null, {
  style: function (feature) {
    var fillColor,
      density = feature.properties.AAA_Seattle_EducationAttain_Class;
    if (density <= 5 && density > 4) fillColor = "#365c96";
    else if (density <= 4 && density > 3) fillColor = "#5681c2";
    else if (density <= 3 && density > 2) fillColor = "#8fabd6";
    else if (density <= 2 && density > 1) fillColor = "#c7d5eb";
  ...
  onEachFeature: function (feature, layer) {
    layer.bindPopup(
      ...
      "</strong>" +
      feature.properties.AAA_Seattle_EducationAttain_Class
    );
  },
});
...
var rent = L.geoJson(null, {
  style: function (feature) {
    var fillColor,
      density = feature.properties.AAA_Seattle_Rent_Class;
    if (density <= 5 && density > 4) fillColor = "#365c96";
    else if (density <= 4 && density > 3) fillColor = "#5681c2";
    else if (density <= 3 && density > 2) fillColor = "#8fabd6";
    else if (density <= 2 && density > 1) fillColor = "#c7d5eb";
  ...
  onEachFeature: function (feature, layer) {
    layer.bindPopup(
      ...
      "Rent Class: " +
      "</strong>" +
      feature.properties.AAA_Seattle_Rent_Class
    );
  },
});
...
var mortgage = L.geoJson(null, {
  style: function (feature) {
    var fillColor,
      density = feature.properties.AAA_Seattle_Mortgage_Class;
    if (density <= 5 && density > 4) fillColor = "#365c96";
    else if (density <= 4 && density > 3) fillColor = "#5681c2";
    else if (density <= 3 && density > 2) fillColor = "#8fabd6";
    else if (density <= 2 && density > 1) fillColor = "#c7d5eb";
  ...
  onEachFeature: function (feature, layer) {
    layer.bindPopup(
      ...
      "Mortgage Class: " +
      "</strong>" +
      feature.properties.AAA_Seattle_Mortgage_Class
    );
  },
});
...
var community = L.geoJson(null, {
  style: function (feature) {
    var fillColor,
      density = feature.properties.AAA_Seattle_Community_Class;
    if (density <= 5 && density > 4) fillColor = "#365c96";
    else if (density <= 4 && density > 3) fillColor = "#5681c2";
    else if (density <= 3 && density > 2) fillColor = "#8fabd6";
    else if (density <= 2 && density > 1) fillColor = "#c7d5eb";
  ...
  onEachFeature: function (feature, layer) {
    layer.bindPopup(
      ...
      "Community Class: " +
      "</strong>" +
      feature.properties.AAA_Seattle_Community_Class
    );
  },
});
...
var vehicle = L.geoJson(null, {
  style: function (feature) {
    var fillColor,
      density = feature.properties.AAA_Seattle_Vehicle_Class;
    if (density <= 5 && density > 4) fillColor = "#365c96";
    else if (density <= 4 && density > 3) fillColor = "#5681c2";
    else if (density <= 3 && density > 2) fillColor = "#8fabd6";
    else if (density <= 2 && density > 1) fillColor = "#c7d5eb";
  ...
  onEachFeature: function (feature, layer) {
    layer.bindPopup(
      ...
      "Vehicle Class: " +
      "</strong>" +
      feature.properties.AAA_Seattle_Vehicle_Class
    );
  },
});
...
$.getJSON("Seattle_Tech_Companies.json", function (data) {
...
var groupOverLays = {
  "Seattle Layers": {
    "Seattle Tech Companies": companies,
