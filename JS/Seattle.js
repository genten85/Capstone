...
var race = L.geoJson(null, {
  style: function (feature) {
    var fillColor,
      density = feature.properties.Seattle_29;
  ...
  onEachFeature: function (feature, layer) {
    layer.bindPopup(
      "<strong>" +
        "Percent of Race: " +
        "</strong>" +
        feature.properties.Seattle_29 +
        "</br><strong>" +
        "Total: " +
        "</strong>" +
        feature.properties.Seattle_PO +
        "</br><strong>" +
        "White: " +
        "</strong>" +
        feature.properties.Seattle_28
    );
  },
});
...
var opportunity = L.geoJson(null, {
  style: function (feature) {
    var fillColor,
      density = feature.properties.Seattle_23;
    if (density <= 5 && density > 4) fillColor = "#365c96";
    else if (density <= 4 && density > 3) fillColor = "#5681c2";
    else if (density <= 3 && density > 2) fillColor = "#8fabd6";
    else if (density <= 2 && density > 1) fillColor = "#c7d5eb";
