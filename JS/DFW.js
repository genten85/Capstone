...
var Dallas_race = L.geoJson(null, {
  style: function (feature) {
    var fillColor,
      density = feature.properties.AAA_Dal_27;
  ...
  onEachFeature: function (feature, layer) {
    layer.bindPopup(
      "<strong>" +
        "Percent of Race: " +
        "</strong>" +
        feature.properties.AAA_Dal_27 +
        "</br><strong>" +
        "Total: " +
        "</strong>" +
        feature.properties.AAA_Dal_25 +
        "</br><strong>" +
        "White: " +
        "</strong>" +
        feature.properties.AAA_Dal_26
    );
  },
});
...
var Dallas_ALICE = L.geoJson(null, {
  style: function (feature) {
    var fillColor,
      density = feature.properties.ALICE_Clas;
  ...
  onEachFeature: function (feature, layer) {
    layer.bindPopup(
      "<strong>" + "ALICE Class: " + "</strong>" + feature.properties.ALICE_Clas
    );
  },
});
...
var Dallas = L.geoJson(null, {
  style: function (feature) {
    var fillColor,
      density = feature.properties.AAA_Dal_23;
    if (density <= 5 && density > 4) fillColor = "#365c96";
    else if (density <= 4 && density > 3) fillColor = "#5681c2";
    else if (density <= 3 && density > 2) fillColor = "#8fabd6";
    else if (density <= 2 && density > 1) fillColor = "#c7d5eb";
...
var Fort_Worth_race = L.geoJson(null, {
  style: function (feature) {
    var fillColor,
      density = feature.properties.AAA_Ft__27;
  ...
  onEachFeature: function (feature, layer) {
    layer.bindPopup(
      "<strong>" +
        "Percent of Race: " +
        "</strong>" +
        feature.properties.AAA_Ft__27 +
        "</br><strong>" +
        "Total: " +
        "</strong>" +
        feature.properties.AAA_Ft__25 +
        "</br><strong>" +
        "White: " +
        "</strong>" +
        feature.properties.AAA_Ft__26
    );
  },
});
...
var FortWorth = L.geoJson(null, {
  style: function (feature) {
    var fillColor,
      density = feature.properties.AAA_Ft__24;
    if (density <= 5 && density > 4) fillColor = "#365c96";
    else if (density <= 4 && density > 3) fillColor = "#5681c2";
    else if (density <= 3 && density > 2) fillColor = "#8fabd6";
    else if (density <= 2 && density > 1) fillColor = "#c7d5eb";
